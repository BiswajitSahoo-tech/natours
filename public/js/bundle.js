...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sipun834/cl81vp825007q14pmc4eohld0',
    // this is the link from the studio
    scrollZoom: false // this option is for making scrolling disable

  });
  var bounds = new mapboxgl.LngLatBounds(); // bounds are used for fitting the map to certain location

  locations.forEach(function (loc) {
    //create a new element with class name marker
    var el = document.createElement('div');
    el.className = 'marker'; // add above as Marker

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //for popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML('<p>Day ' + loc.day + ': ' + loc.description + '</p>').addTo(map); // add the loc to the bounds
...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //console.log(el)
...
var showAlerts = function showAlerts(type, msg) {
  hideAlert();
  var clas = "alert alert--" + type;
  var markup = '<div class = "' + clas + '" >' + msg + '</div>';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlerts)('success', 'Logged in successfully'); // alert('success')
          ...
          case 7:
            ...
            (0, _alerts.showAlerts)('error', 'Incorrect Details'); // alert('fail')
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); // true is required becuz we want a page from server not from cache
          ...
          case 7:
            ...
            (0, _alerts.showAlerts)('error', 'try again');
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlerts)('success', 'Sign up successfully'); // alert('success')
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              d = type === 'password' ? 'PASSWORD' : 'DATA';
              (0, _alerts.showAlerts)('success', d + ' updated successfully'); // alert('success')
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            // console.log( err)
            (0, _alerts.showAlerts)('error', _context.t0.response.data.message); // alert('fail')
...
var stripe = Stripe('pk_test_51LjGYDSA8Zve3mCvmd4Zl3MgA12cnIfedKaabFpIUqrDrRzCa6Rsu4YLl5VQwHUPm6TCxHXdg6f8moAccQlY2q5t00MWrJZ7SN');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)('/api/v1/booking/checkout-session/' + tourId);

          case 3:
            session = _context.sent;
            // console.log( session)
            // //2) Create checkout from + charge the credit card
            window.location.replace(session.data.session.url); // console.log(session.data.session.url)
...
var signupBtn = document.getElementById('signupBtn'); //values
//delegation mapping
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //creating the enctype form data
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; //console.log(passwordConfirm, passwordCurrent, password)
